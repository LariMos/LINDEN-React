    ...
    <div className="relative h-screen">
      <div className="relative h-full z-10 flex flex-col justify-center items-center leading-none mx-3 lg:mt-0 md:mt-0">
        ...
        <div className="text-xl lg:text-3xl md:text-2xl sm:text-xl font-archivio leading-6 lg:leading-8">
         <span className="font-chomsky md:text-4xl lg:text-6xl sm:text-xl">The New York Times</span> ARTICLES AT YOUR FINGERTIPS
        </div>
      ...
      <div ref={targetRef} className="relative h-full flex flex-col justify-center align-center z-10 bg-teal-50">
